...
ShutForksFromOutsideCommand::ShutForksFromOutsideCommand() {
...
void ShutForksFromOutsideCommand::Execute() {
...
void ShutForksFromOutsideCommand::End() {
	Robot::fork->forkMotor->Set(0);
}

// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void ShutForksFromOutsideCommand::Interrupted() {
	End();
}
