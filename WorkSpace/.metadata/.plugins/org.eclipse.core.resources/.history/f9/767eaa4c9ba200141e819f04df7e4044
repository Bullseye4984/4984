...
SpeedController* RobotMap::forkSpeedController1 = NULL;
...
void RobotMap::init() {
	...
	forkSpeedController1 = new VictorSP(3);
	lw->AddActuator("Fork", "Speed Controller 1", (VictorSP*) forkSpeedController1);
