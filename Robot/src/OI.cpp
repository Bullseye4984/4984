...
#include "Commands/PickupBinAndMoveForawrdCommandGroup.h"
...
OI::OI(){
	...
	SmartDashboard::PutData("Pickup Bin And Move Forawrd CommandGroup", new PickupBinAndMoveForawrdCommandGroup());
	...
	chooser->AddDefault("Forks all the way out", new ShutForksFromOutsideCommand());
	chooser->AddObject("Forks Touching Bin", new ShutForksFromTouchingCommand());
	SmartDashboard::PutData("Fork Position", chooser);
}
